  ...
  return (
    <div className="absolute top-0 left-0 w-full p-6 z-30 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        <span className="text-white font-black text-xl tracking-[1.2px]">
        Brand
        </span>
      </div>
              ...
              <div className="max-h-64 overflow-y-auto">
                {notifications.length === 0 ? (
                  <div className="p-8 text-center">
                    ...
                    <p className="text-sm font-medium text-[#8A6B52]">
                  ...
                  notifications.map((notif: any, idx: number) => (
                    <div key={idx} className="p-4 border-b border-[#EAE3D9] hover:bg-[#FAF8F6] cursor-pointer transition-colors">
                      <p className="text-sm text-[#5C3A21] font-medium">
                        {notif.message}
                      </p>
                    </div>
                  ))
            ...
            <div className="absolute right-0 mt-4 w-72 bg-[#EAE3D9] rounded-xl shadow-2xl border border-[#D4C8BA] overflow-hidden z-50">
              <div className="bg-[#997855] p-6 flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-white text-s font-bold leading-tight tracking-wide">
                    {userName}
                  </span>

                  <Link
                    href="/profile"
                    className="text-white/90 text-sm hover:text-white underline decoration-1 underline-offset-2 mt-1"
                  >
                    View profile
                  </Link>
                </div>
              ...
              <div className="flex flex-col py-2">
                <Link
                  href="/help"
                  className="px-6 py-2 text-s font-bold text-[#5C3A21] hover:bg-[#DCD1C4]"
                >
                  Help Center
                </Link>
                ...
                <button
                  ...
                  className="w-full text-left px-6 py-2 text-s font-bold text-[#CD5C5C] hover:bg-[#DCD1C4]"
                >
                  Log out
                </button>
              </div>
