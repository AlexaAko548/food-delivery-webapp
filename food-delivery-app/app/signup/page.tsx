      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center relative p-8">
          ...
          <div className="max-w-sm mx-auto w-full relative z-10">
            <h2 className="text-4xl font-bold text-[#5C3A21] mb-8 text-center">Sign Up</h2>
            ...
            <p className="text-center text-[#8A6B52] mt-6 text-sm">
              Already have an account?{" "}
              <Link href="/login" className="text-[#8A6B52] underline decoration-1 hover:text-[#5C3A21] transition-colors">
                Sign in
              </Link>
            </p>
          </div>
